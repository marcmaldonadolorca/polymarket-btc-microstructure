...
el detalle de las características y de los hiperparámetros de los modelos, el pre-registro
completo con el procedimiento para verificar su sello temporal, y una auditoría del registro
público de operaciones que permite reproducir las cifras principales desde el dato anonimizado.
