...
the cost model —documented as a cryptographically timestamped erratum— shows that under
...
candidate, pre-committed gate arms and a taker expectation declared negative in advance— is
...
completan el arco. Primero, una corrección del modelo de costes —documentada como fe de
erratas con sello criptográfico de tiempo— muestra que, bajo el régimen oficial de
...
congelado, brazos de \emph{gate} comprometidos por adelantado y expectativa \emph{taker}
