...
los $\sim$53\,\$ de la validación única de julio, que era fuera de muestra pero se apoyaba
en solo tres días. El retorno medio, por tanto, no mejora ni empeora de forma
...
esperado es de $-232{,}6$\,\$ —frente a los $-235{,}66$ que se observaron— y la
...
solapan casi por completo, lo que crece a lo largo del eje es la densidad de muestreo, no
...
puede beneficiarse de un conjunto de prueba más benévolo.
