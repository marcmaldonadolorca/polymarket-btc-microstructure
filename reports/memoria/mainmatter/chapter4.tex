...
independientes, en el punto máximo del eje ($n_{\text{train}} = 45.000$). Acierto sobre
los mismos 916 casos held-out para los cuatro brazos.}
\label{tab::escalado_trayectorias}
\begin{tabular}{lrrrr}
\hline
\textbf{Brazo} & \textbf{Mercados} & \textbf{Trayectorias} & \textbf{Acierto} & \textbf{Bruto} \\
\hline
Tabular, solo 1h & 509 & 950 & $50{,}55$\,\% & $+0{,}5465$ \\
Profundo, solo 1h & 509 & 950 & $49{,}56$\,\% & $+0{,}6500$ \\
Tabular, 1h+15m+5m & 7.784 & 2.685 & $\mathbf{50{,}87}$\,\% & $+0{,}5312$ \\
Profundo, 1h+15m+5m & 7.784 & 2.685 & $49{,}45$\,\% & $+0{,}7701$ \\
\hline
\end{tabular}
\end{table}

El resultado activa la rama declarada como principal: \textbf{la brecha no se cierra}. La
regla pre-registrada exigía que el brazo profundo superara al tabular por más de un punto
porcentual para considerar que la conclusión publicada era un artefacto del diseño
muestral; queda $1{,}42$ puntos por debajo. La tesis del capítulo se sostiene ahora sobre
el eje correcto, lo que la hace más fuerte, no más débil: ni más muestras solapadas de las
mismas trayectorias ni un número sensiblemente mayor de trayectorias distintas alteran el
orden de mérito entre las dos vías.
