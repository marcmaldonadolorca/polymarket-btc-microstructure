...
El trabajo previo existe y deja un hueco preciso: los estudios
...
conclusión se alcanza por cuatro caminos: el efecto de la latencia sobre la señal
direccional, la estructura oficial de comisiones (que, una vez corregido un error en el
modelo de costes, resulta suficiente por sí sola para agotar el resultado bruto), la
ausencia de cualquier retardo explotable en la incorporación de la información externa, y
una validación prospectiva pre-registrada, ejecutada dos veces sobre una ventana sellada
de antemano y con potencia suficiente para afirmar la ausencia en lugar de sugerirla.
Que varias vías converjan es lo que convierte una observación en una conclusión.
...
\begin{enumerate}[noitemsep]
  ...
  datos, el universo, las variantes, las métricas y las reglas de decisión; ejecutar una
...
\begin{itemize}[noitemsep]
  ...
  fuera de muestra, la corrección del modelo de comisiones, el giro al lado \emph{maker} y la
