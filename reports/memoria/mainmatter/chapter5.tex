...
\emph{settlement} binario $p\,(1-p)$, neutraliza la pérdida terminal que penaliza a la
estrategia pasiva, con una mejora neta modesta cuya magnitud, no obstante, depende del
mismo modelo de \emph{fill} optimista y de la ausencia de respuesta competitiva ya
señalados. Su validación real exige el simulador reactivo antes descrito. La reciente
