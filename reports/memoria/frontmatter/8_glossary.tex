...
\item[\emph{Rebate} de liquidez] Devolución que la plataforma reparte entre quienes
publican órdenes en el libro, financiada con las comisiones que pagan quienes las cruzan.
Es la razón por la que el mismo régimen de comisiones que arruina al \emph{taker}
retribuye al \emph{maker}.
\item[AUC] Área bajo la curva ROC: probabilidad de que el modelo puntúe más alto un caso
positivo que uno negativo tomados al azar. 0,5 es no distinguir nada; 1,0 es separación
perfecta.
\item[Ratio de Sharpe deflactada] Corrección de la ratio de Sharpe que descuenta cuántas
estrategias se probaron antes de quedarse con una; sin ella, buscar lo suficiente garantiza
encontrar un resultado bueno por azar.
\item[Adenda] Ampliación de un pre-registro, sellada con el mismo procedimiento y antes de
observar sus propios datos, para cubrir un experimento que el compromiso original no
contemplaba.
\end{description}
