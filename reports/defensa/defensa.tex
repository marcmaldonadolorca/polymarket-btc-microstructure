...
% Indice superior con la seccion actual resaltada (peticion de la tutora, 25-ago-2026):
% "tambien ayuda un pequeno indice superior".
\setbeamercolor{section in head/foot}{fg=gris}
\setbeamercolor{section in head/foot shaded}{fg=gris!55}
\setbeamerfont{section in head/foot}{size=\tiny}
\setbeamertemplate{headline}{%
  \vspace{0.1em}%
  \hspace{1.2em}\insertsectionnavigationhorizontal{0.95\paperwidth}{}{}%
}
...
\begin{frame}[shrink=8]{La escalera de modelos: el aprendizaje profundo sí se evaluó}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \small
...
\begin{frame}[shrink=8]{Validación prospectiva pre-registrada: NO-GO}
  \begin{columns}[T]
...
\begin{frame}{El cuarto camino, y el que por fin tiene potencia}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \begin{tabular}{lrr}
        \toprule
        \textbf{Capa} & \textbf{Corte 1} & \textbf{Corte 2} \\
        \midrule
        Histórica @0,5 & $-0{,}004$ & $+0{,}075$ \\
        Con comisión real & $-0{,}770$ & $-0{,}691$ \\
        \emph{Taker} entrada & $-1{,}411$ & $-1{,}334$ \\
        \emph{Taker} ida-vuelta & $-3{,}646$ & $-3{,}570$ \\
        \bottomrule
      \end{tabular}

      \vspace{0.5em}
      {\scriptsize Medias en ticks · 50 y 55 días · 25.011 y 27.208 unidades}
    \end{column}
    \begin{column}{0.44\textwidth}
      ...
      \vspace{0.7em}
      Así que no hay deterioro que explicar. Con \textbf{más de 30 veces más datos} la señal
      sigue sin distinguirse del azar: la capa histórica tiene el cero dentro del intervalo en
      los \textbf{dos} cortes, $[-0{,}22;\ +0{,}21]$ y $[-0{,}13;\ +0{,}29]$. Y la comisión
      vigente la vuelve decisivamente negativa en ambos.
    \end{column}
  \end{columns}
...
\begin{frame}[shrink=8]{¿Y si el problema era el objetivo, no la arquitectura?}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
